...
const InfoKlaimTab: React.FC<IInfoKlaimTab> = ({
  ...
  return (
    <div>
      <div className="flex flex-col self-stretch items-center justify-center gap-[5rem] sm:mt-[5rem]">
              ...
              >
                ...
                >
                  ...
                  <div className="flex flex-col items-center justify-between grow">
                    <h5 className="font-karla text-[2rem] font-bold -tracking-[0.03rem] xs:leading-[30px] sm:leading-[38.4px] text-gray-900 dark:text-white text-center">
                      {val.title}
                    </h5>
