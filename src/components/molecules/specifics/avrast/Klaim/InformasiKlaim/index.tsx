...
const InformasiKlaimComponent: React.FC<InformasiKlaimComponentProps> = ({
  ...
  return (
    <div className="w-full flex flex-col self-stretch items-center justify-center xs:px-[2rem] md:px-[8.5rem] bg-white xs:pt-[3.125rem] xs:pb-[2.25rem] md:pt-[6.25rem] md:pb-[4rem] gap-[4rem]">
      {/* Tab Desktop */}
