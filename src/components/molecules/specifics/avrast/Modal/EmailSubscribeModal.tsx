    ...
    <div className="h-[50vh] w-[50vw] transition">
      <div className="absolute right-0 p-[1.5rem]">
        <button onClick={onClose}>
          <Icon name="close" width={1.5} height={1.5} color="white" />
        </button>
      </div>
        ...
        <div className="bg-[#7e3f96] flex items-center flex-col sm:p-0 xs:p-4">
          <div className="mt-[2.5rem]">
            ...
            >
              ...
              />
              <button
                className="bg-white rounded-md px-[1.25rem] py-[0.5rem] font-opensans font-semibold text-[1rem] text-purple_dark"
              >
                Subscribe Sekarang
              </button>
            </form>
