      ...
      <div className="w-full">
        ...
        <div className="w-full -mt-[6px] flex md:flex-row xs:flex-col mb-[5rem]">
          ...
          <div>
            {dropdownVisible && (
              <div
                className={`absolute shadow-xl flex flex-col xs:top-[100vh] md:top-[93vh] md:right-[1rem] rounded-md bg-white xs:right-[1.25rem] xs:left-0 md:left-[50rem] md:w-[31.25rem] z-30`}
                ref={dropdownRef}
              >
                <Link
