    ...
    <div className="flex flex-row px-[136px] py-[72px] gap-[48px]">
      ...
      <div className="flex flex-col gap-[24px] grow">
        <div className="flex flex-row gap-[12px] ">
          <input placeholder="Cari" className="focus:outline-none px-[16px] py-[8px] rounded-[12px] bg-purple_dark/[.06] grow" />
        ...
        <div className="flex flex-row justify-between">
          <p className="text-[20px]">Menampilkan <span className="font-bold text-purple_dark">1-9</span> dari <span className="font-bold">20</span> hasil</p>
