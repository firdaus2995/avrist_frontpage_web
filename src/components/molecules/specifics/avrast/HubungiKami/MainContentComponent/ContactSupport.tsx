  ...
  return (
    <div className="mt-[80px] mx-[136px] grid grid-rows-1 md:grid-cols-5 gap-6">
      ...
      <div className="h-auto md:h-[323px]  border bg-white rounded-2xl border-gray_light overflow-hidden flex flex-col justify-between">
        <Link href='tel:021-5789-8188' className="h-full font-opensans font-bold text-[24px] flex flex-col items-center mt-[36px]">
      ...
      <div className="h-auto md:h-[323px]  border bg-white rounded-2xl border-gray_light overflow-hidden flex flex-col justify-between">
        <Link href='mailto:customer-service@avrist.com' className="h-full font-opensans font-bold md:text-[24px] flex flex-col items-center mt-[36px]">
      ...
      <div className="h-auto md:h-[323px] border bg-white rounded-2xl border-gray_light overflow-hidden flex flex-col justify-between">
        <div className="h-full font-opensans font-bold text-[24px] flex flex-col items-center mt-[36px] text-center">
