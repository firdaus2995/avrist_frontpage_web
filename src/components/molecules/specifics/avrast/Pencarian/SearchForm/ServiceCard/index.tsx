...
const ServiceCard = () => {
  ...
  return (
    <div className="mx-3 p-6 bg-gray_bglightgray rounded-xl grid md:grid-cols-3 grid-cols-1 gap-6">
      <Card
        image={HEART_HAND}
        title="Klaim & Layanan"
...
const Card: React.FC<ICard> = ({ image, title, onClick }) => {
  return (
    <div className="flex flex-col cursor-pointer" onClick={onClick}>
      <div className="w-auto md:h-[220px] bg-white rounded-t-xl pt-[24px] px-[12px] md:px-[24px] pb-[36px] md:grow md:shrink-0 flex md:flex-col gap-4 md:gap-[24px] items-center justify-center text-center">
