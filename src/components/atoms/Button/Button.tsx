...
const BASE_BUTTON_CLASS =
  'inline-block px-12 py-3 text-sm font-medium border rounded active:bg-indigo-500 focus:outline-none focus:ring cursor-pointer select-none ease-in-out duration-150';
