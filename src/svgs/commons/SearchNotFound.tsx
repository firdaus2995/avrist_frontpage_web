...
const SearchNotFound = (props: IIcon) => {
  return (
    <svg
      width={props.width}
      height={props.height}
    ...
    >
      ...
      <path
        ...
        strokeLinecap="round"
      />
      <path d="M148 126L154 132" stroke="#D9D1E0" strokeWidth="2.5" />
      <path
        fill-rule="evenodd"
        clip-rule="evenodd"
        d="M153.031 131.03C151.138 132.923 151.138 135.991 153.031 137.884L164.116 148.969C166.009 150.862 169.078 150.862 170.97 148.969C172.863 147.077 172.863 144.008 170.97 142.115L159.885 131.03C157.992 129.137 154.924 129.137 153.031 131.03Z"
        fill="#F5F3F7"
        stroke="#D9D1E0"
        strokeWidth="2.5"
      />
