...
import ROUNDED_FRAME_BOTTOM_GRAY from '@/assets/images/rounded-frame-bottom-gray.svg';
import ROUNDED_FRAME_TOP_GRAY from '@/assets/images/rounded-frame-top-gray.svg';
