      ...
      <Hero
        ...
        breadcrumbsData={[
          { title: 'Beranda', href: '/avrast' },
          {
            ...
            href: '/avrast/promo-berita/berita?tab=Avrist+Terkini&category=Berita+dan+Kegiatan'
          }
        ]}
      ...
      <div className="flex items-center justify-center w-full">
        <div className="flex flex-col gap-10 w-2/3 p-10">
          ...
          <div className="flex flex-row gap-4">
            <div className="flex flex-row gap-4">
              <p className='text-sm font-medium'>Artikel ini telah di liput di:</p>
          ...
          <div className='flex flex-col gap-5 p-5 border border-b-8 border-b-purple_dark rounded-xl'>
            <p className='font-semibold text-xl'>Informasi lebih lanjut, hubungi:</p>
            <div className='flex flex-col'>
              <p className='font-bold text-xl'>Lika Shalia</p>
              <p className='text-xl'>Head of Corporate & Marketing Communications</p>
            </div>
