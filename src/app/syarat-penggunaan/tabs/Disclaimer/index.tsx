...
const Disclaimer = () => {
  return (
    <div>
      <p className="font-karla font-bold sm:text-[56px] xs:text-[36px] mt-[36px]">Syarat Kegunaan</p>
      ...
      <p className="font-opensans font-normal text-[20px] text-gray_body mt-[24px] leading-[28px]">
        Harap baca informasi ini dengan seksama sebelum menggunakan situs web
        ini.
      </p>
    </div>
  );
