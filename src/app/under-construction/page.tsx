  ...
  return (
    <div>
      <div className="my-[96px] w-full flex flex-col items-center">
        <p className="font-karla font-extrabold md:text-[80px] xs:text-[55px] text-purple_verylight text-center">
          Under Construction
        </p>
        <div className="w-[420px] text-center xs:max-md:px-[50px]">
        ...
        <Link
          href="/"
          className="bg-purple_dark text-white font-opensans font-semibold text-[20px] rounded-lg md:py-[18px] xs:py-[12px] px-[40px] mt-[36px]"
        >
          Kembali Ke Beranda
        </Link>
      </div>
